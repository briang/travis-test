...
=for html <img src="https://travis-ci.org/briang/travis-test.svg?branch=master" alt="TravisCI Status"/>

=for html <img src="https://ci.appveyor.com/api/projects/status/github/briang/travis-test?branch=master&svg=true" alt="AppVeyor Status"/>
